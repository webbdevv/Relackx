...
export default function MessageOptions(props) {
    ...
    return (
        <div className="message-options">
            ...
            <button onClick={props.isAuthor ? editText : null} className="option" onMouseEnter={() => setEdit(true)} onMouseLeave={() => setEdit(false)}>
            ...
            <OptionDetail originalMsg={props.msg} class={`middle${props.isAuthor ? " disabled" : ""}`} msg={props.isAuthor ? "Edit message" : "Disabled"} open={edit} />

            <button className="option" onClick={props.isAuthor ?  () => setDeleteModalOpen(true) : null} onMouseEnter={() => setDelete(true)} onMouseLeave={() => setDelete(false)}>
